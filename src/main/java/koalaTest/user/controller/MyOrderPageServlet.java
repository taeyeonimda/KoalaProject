 ...
 */
@WebServlet(name = "MyOrderPage", urlPatterns = { "/myOrderPage.do" })
public class MyOrderPageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//ArrayList<Order> order = service.selectOrder(userNo);
		OrderPageData opd = service.selectMyOrderList(reqPage, userNo);
		// 4. 결과 처리
		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/views/user/myOrderPage.jsp");
